...
# Combine the two datasets
     ...
     p1 <- ggplot(comp_sim2, mapping = aes(x = time, y = cort, by = animal_sample, color = type)) +
      ...
      sim_grpa$true_values$type <- "Treatment"
      sim_a22 <- sim_grpa$true_values[, c("baseline", "slope", "fastpct", "speed", "max", "atmax", "type")]
      sim_grpb$true_values$type <- "Control"
      sim_b22 <- sim_grpb$true_values[, c("baseline", "slope", "fastpct", "speed", "max", "atmax", "type")]
     
      comp_sim3 <- rbind(sim_a22, sim_b22)
      comp_sim4 <- pivot_longer(comp_sim3, cols = c("baseline", "slope", "fastpct", "speed", "max", "atmax"), names_to = "trait", values_to = "value")
     
      ggplot(comp_sim4, mapping = aes(x = type, y = value, color = type, fill = type)) +
     ...
     p2 <- ggplot(comp_sim2, mapping = aes(x = time, y = cort, color = type, fill = type)) +
       geom_smooth() +
       theme_classic() + 
...
How to interpret some of the empirical studies that are published in light of simulations?
